...
public class CliUtil {
    ...
    public static ExpertRuleVar warn(ParserRuleContext ctx, String msg) {
        if(isRuntime) return ExpertRuleVar.makeVoid();
    ...
    public static ExpertRuleVar err(ParserRuleContext ctx, String msg, String errType) {
        Token firstToken = ctx.getStart();
        String source = firstToken.getInputStream().toString();
    ...
    public static ExpertRuleVar err(ParserRuleContext ctx, String msg) {
